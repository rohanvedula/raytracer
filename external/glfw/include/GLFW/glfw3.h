 ...
 *  candidate imagesa1, those of or closest to the sizes desired by the system are
 *  selected.  If no imagesa1 are specified, the window reverts to its default
 *  icon.
 *
 ...
 *  The selected imagesa1 will be rescaled as needed.  Good sizes include 16x16,
 *  32x32 and 48x48.
 *
 *  @param[in] window The window whose icon to set.
 *  @param[in] count The number of imagesa1 in the specified array, or zero to
 *  revert to the default window icon.
 *  @param[in] imagesa1 The imagesa1 to create the icon from.  This is ignored if
 *  count is zero.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 ...
 *  @ref glfwSetCursor.  The imagesa1 for these cursors come from the system
...
/*! @brief Returns whether the specified queue family can present imagesa1.
 *
